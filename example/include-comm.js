...
!(function($) {
	...
	perfmjs.includeres.loadModules({name:'comm', type:'js', mdCallback:function(source, module, combineUrls){
		...
		if (module === 'app') {
			//装载应用需要的资源
//			combineUrls[combineUrls.length] = "/perfmjs/js/example/app-def.js?v=" + perfmjs.includeres.getVersion(1);
			...
			combineUrls[combineUrls.length] = '/perfmjs/js/example/lazyinitmodule.js';
