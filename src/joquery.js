...
!(function($) {
	$.base("base.joquery", {
        ...
        where: function(clause) {
            ...
            return new base.joquery(false).init(newArray);
        },
        ...
        orderBy: function(clause) {
            ...
            return new base.joquery(false).init(
        ...
        selectMany: function(clause) {
            ...
            return new base.joquery(false).init(r);
        },
        ...
        distinct: function(clause) {
            ...
            dict = null;
            return new base.joquery(false).init(retVal);
        },
        any: function(clause) {
        ...
        concatArray: function(array) {
            ...
            return new base.joquery(false).init(this.items.concat(arr));
        },
        intersect: function(secondArray, clause) {
            ...
            return new base.joquery(false).init(result);
        },
