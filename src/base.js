...
!(function($) {
	...
	$.base = function(name, prototype, parentPrototype, parentDefaults) {
		...
		$[name] = $[namespace][name] = function(callInitFunc, options) {
			...
			this.name = name;
			this.options = perfmjs.utils.extend({}, parentDefaults, $[namespace][name].defaults, options);
		...
		$[namespace][name].prototype = perfmjs.utils.extend(true, {}, parentPrototype, prototype);
